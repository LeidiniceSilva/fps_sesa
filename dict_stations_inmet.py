...
> {station}
    ...
    where:
        ...
        Automatic station name: code, name, latitude, longiitude
...
inmet = {1	:['A899', 'SANTA_VITORIA_DO_PALMAR',			 -33.74166666,	-53.37138888],
		...
		94	:['A715', 'SAO MIGUEL_ARCANJO',	                 -23.85138888,	-48.16444444],
		...
		101	:['A821', 'JOAQUIM TAVORA',	                     -23.50527777,	-49.94638888],
		102	:['A701', 'SAO PAULO - MIRANTE',	             -23.48333333,	-46.61666666],
		103	:['A752', 'ITAQUIRAI',	                         -23.44944444,	-54.18166666],
		104	:['A835', 'MARINGA',	                         -23.40777777,	-51.91666666],
		105	:['A842', 'NOVA FATIMA',	                     -23.40694444,	-50.57777777],
		106	:['A824', 'ICARAIMA',	                         -23.39027777,	-53.63472221],
		107	:['A869', 'CIDADE GAUCHA',	                     -23.37583332,	-52.93194443],
		108	:['A713', 'SOROCABA',                            -23.35000000,	-47.66666666],
		109	:['A740', 'SAO LUIS DO PARAITINGA',	             -23.22833332,	-45.41722221],
		...
		115	:['A652', 'FORTE DE COPACABANA',	             -22.98833333,	-43.19027777],
		116	:['A606', 'ARRAIAL DO CABO',	                 -22.98333333,	-42.01666666],
		117	:['A628', 'ANGRA DOS REIS',	                     -22.97583332,	-44.30333333],
		118	:['S702', 'ARAL MOREIRA',	                     -22.95500000,	-55.62611110],
		119	:['A716', 'OURINHOS',	                         -22.94861110,	-49.89416666],
		120	:['A636', 'RIO_DE_JANEIRO - JACAREPAGUA',	     -22.93972221,	-43.40277777],
		...
		126	:['A601', 'ECOLOGIA AGRICOLA',	                 -22.80000000,	-43.68333333],
		127	:['A706', 'CAMPOS DO JORDAO',	                 -22.75027777,	-45.60388888],
		128	:['A726', 'PIRACICABA',	                         -22.70277777,	-47.62305554],
		129	:['A769', 'CACHOEIRA PAULISTA',	                 -22.68888888,	-45.00555555],
		130	:['S706', 'CAARAPO',	                         -22.65694444,	-54.81944443],
		131	:['A626', 'RIO CLARO',	                         -22.65361111,	-44.04083333],
		132	:['A659', 'SILVA JARDIM',	                     -22.64583333,	-42.41583333],
		133	:['A849', 'DIAMANTE DO NORTE',	                 -22.63388888,	-52.85888888],
		134	:['A603', 'XEREM',	                             -22.58972221,	-43.28222221],
		135	:['S711', 'LAGUNA CARAPA',	                     -22.57527777,	-55.16027777],
		136	:['A703', 'PONTA PORA',	                         -22.55250000,	-55.71638888],
		137	:['A850', 'PARANAPOEMA',	                     -22.49166666,	-52.13444444],
		138	:['A610', 'PICO DO COUTO',	                     -22.48166666,	-43.29138888],
		...
		142	:['A529', 'PASSA QUATRO',	                     -22.39611110,	-44.96166666],
		...
		197	:['A561', 'SAO_SEBASTIAO DO PARAISO',	         -20.91000000,	-47.11416666],
		...
		223	:['A555', 'IBIRITE_(ROLA_MOCA)',	             -20.03111110,	-44.01111111],
