...
iy, ix, clim_i = import_inmet(type_cycle)			
jy, jx, clim_j = import_urug_smn(type_cycle)
ky, kx, clim_k = import_arg_emas(type_cycle)
...
name_out = 'pyplt_era5_dendrogram_{0}.png'.format(type_cycle)
