...
print(std_regcm_cluster_i, std_inmet_cluster_i, std_era5_cluster_i)
print(std_regcm_cluster_ii, std_inmet_cluster_ii, std_era5_cluster_ii)
print(std_regcm_cluster_iii, std_inmet_cluster_iii, std_era5_cluster_iii)
print(std_regcm_cluster_iv, std_inmet_cluster_iv, std_era5_cluster_iv)
print(std_regcm_cluster_v, std_inmet_cluster_v, std_era5_cluster_v)

print(corr_regcm_inmet_cluster_i, corr_regcm_era5_cluster_i)
print(corr_regcm_inmet_cluster_ii, corr_regcm_era5_cluster_ii)
print(corr_regcm_inmet_cluster_iii, corr_regcm_era5_cluster_iii)
print(corr_regcm_inmet_cluster_iv, corr_regcm_era5_cluster_iv)
print(corr_regcm_inmet_cluster_v, corr_regcm_era5_cluster_v)
exit()
