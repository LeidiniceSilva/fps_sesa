...
for station in range(1, 567):
	...
	data = pd.read_csv(os.path.join('{0}/inmet_csv/{1}/'.format(path, freq), 'dados_{0}_{1}_2018-01-01_2021-12-31.csv'.format(inmet[station][0], freq_i)), skiprows=9, encoding='ISO-8859-1', decimal=',', delimiter=';')
	...
	nc_output = '{0}/inmet_nc/{1}/{2}/{2}_{3}_{4}_2018-01-01_2021-12-31.nc'.format(path, freq, nc_var, inmet[station][0], freq_i)
