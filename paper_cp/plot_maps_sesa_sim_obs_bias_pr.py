...
wrf_ncar_inmet_smn = bias_iii_x + bias_i_y
...
plt.title('(a) RegCM USP - INMET+SMN', loc='left', fontsize=8, fontweight='bold')
...
plt.title('(b) WRF NCAR - INMET+SMN', loc='left', fontsize=8, fontweight='bold')

ax = fig.add_subplot(2, 3, 3)
my_map = basemap()
pltfig = my_map.scatter(lon_xx, lat_yy, 5, wrf_ucan_inmet_smn, cmap=color, marker='o', vmin=v_min, vmax=v_max)
plt.title('(c) WRF UCAN - INMET+SMN', loc='left', fontsize=8, fontweight='bold')
...
plt.title('(d) RegCM USP - ERA5', loc='left', fontsize=8, fontweight='bold')
...
plt.title('(e) WRF NCAR - ERA5', loc='left', fontsize=8, fontweight='bold')
plt.xlabel(u'Longitude', labelpad=15, fontsize=8, fontweight='bold')

ax = fig.add_subplot(2, 3, 6)
my_map = basemap()
pltfig = my_map.scatter(lon_xx, lat_yy, 5, wrf_ucan_reanalise, cmap=color, marker='o', vmin=v_min, vmax=v_max)
plt.title('(f) WRF UCAN - ERA5', loc='left', fontsize=8, fontweight='bold')
plt.xlabel(u'Longitude', labelpad=15, fontsize=8, fontweight='bold')
cbar = my_map.colorbar(shrink=0.8, pad=0.1, extend='both')
cbar.set_label('{0}'.format(legend), fontsize=8, fontweight='bold')
cbar.ax.tick_params(labelsize=8)
