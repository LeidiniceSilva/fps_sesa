...
def import_smn_ii():
	...
	for i in range(1, 110):
		...
		# Reading wrf cima
		d_ix = xr.open_dataset('/home/mda_silv/clima-archive2-b/FPS-SESA/rcm/wrf_cima/{0}/'.format(var) + '{0}_{1}_{2}_D_2018-06-01-2021-05-31.nc'.format(var, station_code, station_name))
		d_ix = d_ix[var].sel(time=slice('2018-06-01','2021-05-31'))
		d_ix = d_ix.sel(time=d_ix.time.dt.month.isin(seas))
...
lat_z, lon_z, mean_i_z, mean_ii_z, mean_iii_z, mean_iv_z, mean_v_z, mean_vi_z, mean_vii_z, mean_viii_z, mean_ix_z = import_smn_ii()			
...
wrf_cima    = mean_ix_x   + mean_ix_y   + mean_ix_z
...
ct2 = ax2.scatter(lon_xx, lat_yy, 20, bias_perc_era5, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax2.set_title('(b)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax2)

ct3 = ax3.scatter(lon_xx, lat_yy, 20, bias_freq_era5, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax3.set_title('(c)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax3)

ct4 = ax4.scatter(lon_xx, lat_yy, 20, bias_int_era5, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax4.set_title('(d)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax4)

ct5 = ax5.scatter(lon_xx, lat_yy, 20, bias_mean_reg_usp, cmap=cmap, norm=norm_i, marker='o', edgecolor='black', linewidth=0.5)
ax5.set_title('(e)', loc='left', fontweight='bold', fontsize=font_size)
ax5.set_ylabel('Reg4 - WS', rotation='vertical', fontsize=font_size)
configure_subplot(ax5)

ct6 = ax6.scatter(lon_xx, lat_yy, 20, bias_perc_reg_usp, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax6.set_title('(f)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax6)

ct7 = ax7.scatter(lon_xx, lat_yy, 20, bias_freq_reg_usp, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax7.set_title('(g)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax7)

ct8 = ax8.scatter(lon_xx, lat_yy, 20, bias_int_reg_usp, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax8.set_title('(h)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax8)

ct9 = ax9.scatter(lon_xx, lat_yy, 20, bias_mean_reg_ictp, cmap=cmap, norm=norm_i, marker='o', edgecolor='black', linewidth=0.5)
ax9.set_title('(i)', loc='left', fontweight='bold', fontsize=font_size)
ax9.set_ylabel(u'Reg5 - WS', fontsize=font_size)
configure_subplot(ax9)

ct10 = ax10.scatter(lon_xx, lat_yy, 20, bias_perc_reg_ictp, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax10.set_title('(j)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax10)

ct11 = ax11.scatter(lon_xx, lat_yy, 20, bias_freq_reg_ictp, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax11.set_title('(k)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax11)

ct12 = ax12.scatter(lon_xx, lat_yy, 20, bias_int_reg_ictp, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax12.set_title('(l)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax12)

ct13 = ax13.scatter(lon_xx, lat_yy, 20, bias_mean_reg_ictp_i, cmap=cmap, norm=norm_i, marker='o', edgecolor='black', linewidth=0.5)
ax13.set_title('(m)', loc='left', fontweight='bold', fontsize=font_size)
ax13.set_ylabel('Reg5-Holt - WS', rotation='vertical', fontsize=font_size)
configure_subplot(ax13)

ct14 = ax14.scatter(lon_xx, lat_yy, 20, bias_perc_reg_ictp_i, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax14.set_title('(n)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax14)

ct15 = ax15.scatter(lon_xx, lat_yy, 20, bias_freq_reg_ictp_i, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax15.set_title('(o)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax15)

ct16 = ax16.scatter(lon_xx, lat_yy, 20, bias_int_reg_ictp_i, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax16.set_title('(p)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax16)

ct17 = ax17.scatter(lon_xx, lat_yy, 20, bias_mean_reg_ictp_ii, cmap=cmap, norm=norm_i, marker='o', edgecolor='black', linewidth=0.5)
ax17.set_title('(q)', loc='left', fontweight='bold', fontsize=font_size)
ax17.set_ylabel('Reg5-UW - WS', rotation='vertical', fontsize=font_size)
configure_subplot(ax17)

ct18 = ax18.scatter(lon_xx, lat_yy, 20, bias_perc_reg_ictp_ii, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax18.set_title('(r)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax18)

ct19 = ax19.scatter(lon_xx, lat_yy, 20, bias_freq_reg_ictp_ii, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax19.set_title('(s)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax19)

ct20 = ax20.scatter(lon_xx, lat_yy, 20, bias_int_reg_ictp_ii, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax20.set_title('(t)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax20)

ct21 = ax21.scatter(lon_xx, lat_yy, 20, bias_mean_wrf_ncar, cmap=cmap, norm=norm_i, marker='o', edgecolor='black', linewidth=0.5)
ax21.set_title('(u)', loc='left', fontweight='bold', fontsize=font_size)
ax21.set_ylabel('WRF-NCAR - WS', rotation='vertical', fontsize=font_size)
configure_subplot(ax21)

ct22 = ax22.scatter(lon_xx, lat_yy, 20, bias_perc_wrf_ncar, cmap=cmap, norm=norm_ii, marker='o', edgecolor='black', linewidth=0.5)
ax22.set_title('(v)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax22)

ct23 = ax23.scatter(lon_xx, lat_yy, 20, bias_freq_wrf_ncar, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax23.set_title('(w)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax23)

ct24 = ax24.scatter(lon_xx, lat_yy, 20, bias_int_wrf_ncar, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
...
ax26.set_title('(z)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax26)

ct27 = ax27.scatter(lon_xx, lat_yy, 20, bias_freq_wrf_ucan, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax27.set_title('(a.1)', loc='left', fontweight='bold', fontsize=font_size)
configure_subplot(ax27)

ct28 = ax28.scatter(lon_xx, lat_yy, 20, bias_int_wrf_ucan, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax28.set_title('(b.1)', loc='left', fontweight='bold', fontsize=font_size)
...
ax30.set_title('(d.1)', loc='left', fontweight='bold', fontsize=font_size)
ax30.set_xlabel('P99 ({0})'.format(legend), loc='center', fontsize=font_size)
configure_subplot(ax30)

ct31 = ax31.scatter(lon_xx, lat_yy, 20, bias_freq_wrf_cima, cmap=cmap, norm=norm_iii, marker='o', edgecolor='black', linewidth=0.5)
ax31.set_title('(e.1)', loc='left', fontweight='bold', fontsize=font_size)
ax31.set_xlabel('FREQUENCY (%)', loc='center', fontsize=font_size)
configure_subplot(ax31)

ct32 = ax32.scatter(lon_xx, lat_yy, 20, bias_int_wrf_cima, cmap=cmap, norm=norm_iv, marker='o', edgecolor='black', linewidth=0.5)
ax32.set_title('(f.1)', loc='left', fontweight='bold', fontsize=font_size)
ax32.set_xlabel('INTENSITY ({0})'.format(legend), loc='center', fontsize=font_size)
configure_subplot(ax32)

cbar = plt.colorbar(ct1, cax=fig.add_axes([0.92, 0.71, 0.015, 0.16]), extend='neither')
cbar.ax.tick_params(labelsize=font_size)
cbar.set_label('MEAN ({0})'.format(legend), fontsize=font_size)

cbar = plt.colorbar(ct2, cax=fig.add_axes([0.92, 0.51, 0.015, 0.16]), extend='neither')
cbar.ax.tick_params(labelsize=font_size)
cbar.set_label('P99 ({0})'.format(legend), fontsize=font_size)

cbar = plt.colorbar(ct3, cax=fig.add_axes([0.92, 0.31, 0.015, 0.16]), extend='neither')
cbar.ax.tick_params(labelsize=font_size)
cbar.set_label('FREQUENCY (%)', fontsize=font_size)

cbar = plt.colorbar(ct4, cax=fig.add_axes([0.92, 0.12, 0.015, 0.16]), extend='neither')
cbar.ax.tick_params(labelsize=font_size)
cbar.set_label('INTENSITY ({0})'.format(legend), fontsize=font_size)

# Path out to save figure
path_out = '{0}/figs/paper_cp'.format(path)
name_out = 'pyplt_maps_bias_sesa_{0}_mmd_{1}.png'.format(var, seas_)
