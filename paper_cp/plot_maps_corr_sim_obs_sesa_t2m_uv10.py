...
plt.title('(a) RegCM4 vs. INMET', loc='left', fontsize=font_size, fontweight='bold')
...
plt.title('(d) WRF415 vs. INMET', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(2, 5, 5)
my_map = basemap()
pltfig = my_map.scatter(lon_xx, lat_yy, 5, wrf_ucan_inmet_smn, cmap=color, marker='o', vmin=v_min, vmax=v_max)
plt.title('(e) WRF433 vs. INMET', loc='left', fontsize=font_size, fontweight='bold')
