...
for idx in list_st:
	...
	# Reading smn station
	data = np.loadtxt(os.path.join('/afs/ictp.it/home/m/mda_silv/Documents/FPS_SESA/database/obs/smn_ii/', 'tmin_BrasUruArgPar_D_19790101-20211231.csv'), dtype='str', delimiter=',', unpack=True)
	data = data[:,1:]
	...
	nc_output = '/afs/ictp.it/home/m/mda_silv/Documents/FPS_SESA/database/obs/smn_ii/smn_nc/tmin/tmin_{0}_D_1979-01-01_2021-12-31.nc'.format(smn_iii[idx+1][0])
