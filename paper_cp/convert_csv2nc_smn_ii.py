...
for idx in range(0, 98):
	...
	# Reading smn station
	data = np.loadtxt(os.path.join('/afs/ictp.it/home/m/mda_silv/Documents/FPS_SESA/database/obs/smn_ii/', '{0}_BrasUruArgPar_D_19790101-20211231.csv'.format(var)), dtype='str', delimiter=',', unpack=True)
	data = data[:,1:]
	...
	nc_output = '/afs/ictp.it/home/m/mda_silv/Documents/FPS_SESA/database/obs/smn_ii/smn_nc/{0}/{0}_{1}_D_1979-01-01_2021-12-31.nc'.format(var, smn_ii[idx+1][0])
