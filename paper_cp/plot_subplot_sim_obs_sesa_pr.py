...
plt.xticks(x, ('RegCM USP','RegCM ICTP Holtslag','RegCM ICTP UW-PBL','WRF NCAR','WRF UCAN','INMET+SMN','ERA5'))
...
plt.plot(x_reg_ictp_i_ccdf, reg_ictp_i_ccdf, marker='.', markersize=4, markerfacecolor='gray', markeredgecolor='gray', linestyle='None', label='RegCM ICTP Holtslag')
plt.plot(x_reg_ictp_ii_ccdf, reg_ictp_ii_ccdf, marker='.', markersize=4, markerfacecolor='brown', markeredgecolor='brown', linestyle='None', label='RegCM ICTP UW-PBL')
...
plt.plot(time, clim_reg_ictp_i, linewidth=1.5, linestyle='--', markersize=3, marker='+', markerfacecolor='white', color='gray', label = 'RegCM ICTP Holtslag')
plt.plot(time, clim_reg_ictp_ii, linewidth=1.5, linestyle='--', markersize=3, marker='d', markerfacecolor='white', color='brown', label = 'RegCM ICTP UW-PBL')
...
plt.plot(reg_ictp_i_dt, linewidth=1, linestyle='--', color='gray', label = 'RegCM ICTP Holtslag')
plt.plot(reg_ictp_ii_dt, linewidth=1, linestyle='--', color='brown', label = 'RegCM ICTP UW-PBL')
