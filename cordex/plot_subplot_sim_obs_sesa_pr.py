...
day_era5 = np.array(day_era5)
day_era5 = day_era5.flatten()

day_reg_usp = np.array(day_reg_usp)
day_reg_usp = day_reg_usp.flatten()

day_reg_ictp_i = np.array(day_reg_ictp_i)
day_reg_ictp_i = day_reg_ictp_i.flatten()

day_reg_ictp_ii = np.array(day_reg_ictp_ii)
day_reg_ictp_ii = day_reg_ictp_ii.flatten()

day_wrf_ncar = np.array(day_wrf_ncar)
day_wrf_ncar = day_wrf_ncar.flatten()
...
plt.plot(time, clim_inmet_smn, linewidth=1.5, color='black', label = 'INMET+SMN')
plt.plot(time, clim_era5, linewidth=1.5, color='red', label = 'ERA5')
plt.plot(time, clim_reg_usp, linewidth=1.5, linestyle='--', markersize=3, marker='o', markerfacecolor='white', color='blue', label = 'Reg4')
plt.plot(time, clim_reg_ictp_i, linewidth=1.5, linestyle='--', markersize=3, marker='+', markerfacecolor='white', color='gray', label = 'Reg5-Holt')
plt.plot(time, clim_reg_ictp_ii, linewidth=1.5, linestyle='--', markersize=3, marker='d', markerfacecolor='white', color='brown', label = 'Reg5-UW')
plt.plot(time, clim_wrf_ncar, linewidth=1.5, linestyle='--', markersize=3, marker='x', markerfacecolor='white', color='green', label = 'WRF-NCAR')
plt.plot(time, clim_wrf_ucan, linewidth=1.5, linestyle='--', markersize=3, marker='^', markerfacecolor='white', color='orange', label = 'WRF-UCAN')
...
plt.plot(inmet_smn_dt, linewidth=1, linestyle='--', color='black', label = 'INMET+SMN')
plt.plot(era5_dt, linewidth=1, linestyle='--', color='red', label = 'ERA5')
plt.plot(reg_usp_dt, linewidth=1, linestyle='--', color='blue', label = 'Reg4')
plt.plot(reg_ictp_i_dt, linewidth=1, linestyle='--', color='gray', label = 'Reg5-Holt')
plt.plot(reg_ictp_ii_dt, linewidth=1, linestyle='--', color='brown', label = 'Reg5-UW')
